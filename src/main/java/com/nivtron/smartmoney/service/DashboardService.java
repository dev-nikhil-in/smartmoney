...
public class DashboardService {
    ...
    public DashboardResponse getDashboard(String email) {
        ...
        BigDecimal monthlyEmi = loans.stream()
                .map(EntityLoan::getEmiAmount)
                .reduce(BigDecimal.ZERO, BigDecimal::add);

        HighInterestAlert highInterestAlert = loans.stream()
        ...
        List<LoanSummary> loanBreakdown = loans.stream()
                .map(loan -> {
